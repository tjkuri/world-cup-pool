...
const ExactHistogram = lazy(() => import('./components/ExactHistogram.jsx').then((m) => ({ default: m.ExactHistogram })));
          ...
          <Suspense fallback={<div className="text-slate-500">Loading chart…</div>}>
            ...
            <section>
              ...
              <div className="space-y-8">
                ...
                <ExactHistogram submissions={data.submissions} fixtures={data.fixtures} results={data.results} knockout={data.knockout} />
              </div>
            </section>
          </Suspense>
        </ErrorBoundary>
